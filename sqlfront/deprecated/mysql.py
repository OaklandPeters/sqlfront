...
@todo: Switch more of these functions to using the 'Qualifier' operator.
"""
__version__ = '0.2'
import os, sys
...
import rich_core #pylint: disable=relative-import
...
#             return True
    ...
    def insert(self, table, data, database=None):
        ...
        table_name = Qualified(table, database=database)
